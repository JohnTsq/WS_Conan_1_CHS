tool\PixelPet\PixelPet.exe ^
    ...
    Import-Bitmap "graphic\gfx_0BE67C\0F41A9_chs.png" --format 32BPP ^
    Generate-Tilemap WS --height 144^
    Import-Bitmap "graphic\gfx_0BE67C\pal5_00-9C-BD-FF.png" Read-Palettes --palette-number 5 --palette-size 4 ^
    ...
    Serialize-Tileset Export-Bytes "graphic\gfx_0BE67C\0F4999-0F61E0_chs.2bpp" ^
    Serialize-Tilemap Export-Bytes "graphic\gfx_0BE67C\0F41A9_chs.tilemap" ^
    || exit /b 1
