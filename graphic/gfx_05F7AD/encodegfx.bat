tool\PixelPet\PixelPet.exe ^
    ...
    Import-Bitmap "graphic\gfx_05F7AD\0F209F_chs.png" --format 32BPP ^
    Generate-Tilemap WS --height 144^
    Import-Bitmap "graphic\gfx_05F7AD\pal5_00-9C-BD-FF.png" Read-Palettes --palette-number 5 --palette-size 4 ^
    ...
    Serialize-Tileset Export-Bytes "graphic\gfx_05F7AD\0F288F-0F41A9_chs.2bpp" ^
    Serialize-Tilemap Export-Bytes "graphic\gfx_05F7AD\0F209F_chs.tilemap" ^
    || exit /b 1
