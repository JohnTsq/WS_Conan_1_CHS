tool\PixelPet\PixelPet.exe ^
    ...
    Import-Bitmap "graphic\gfx_0CDB48\0F82F9_chs.png" --format 32BPP ^
    Generate-Tilemap WS --height 144^
    Import-Bitmap "graphic\gfx_0CDB48\pal5_00-9C-BD-FF.png" Read-Palettes --palette-number 5 --palette-size 4 ^
    ...
    Serialize-Tileset Export-Bytes "graphic\gfx_0CDB48\0F8AE9-0FA5CB_chs.2bpp" ^
    Serialize-Tilemap Export-Bytes "graphic\gfx_0CDB48\0F82F9_chs.tilemap" ^
    || exit /b 1
