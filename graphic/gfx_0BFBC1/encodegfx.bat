tool\PixelPet\PixelPet.exe ^
    ...
    Import-Bitmap "graphic\gfx_0BFBC1\017536_chs.png" --format 32BPP ^
    Generate-Tilemap WS --height 144^
    Import-Bitmap "graphic\gfx_0BFBC1\pal5_00-9C-BD-FF.png" Read-Palettes --palette-number 5 --palette-size 4 ^
    ...
    Serialize-Tileset Export-Bytes "graphic\gfx_0BFBC1\017D26-019654_chs.2bpp" ^
    Serialize-Tilemap Export-Bytes "graphic\gfx_0BFBC1\017536_chs.tilemap" ^
    || exit /b 1
